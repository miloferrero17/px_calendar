...
'''
python3 ./backend/wa/appointment_request.py --email milonguitaferrero@gmail.com --nombre "Juan Perez" --dni "12345678"
# backend/wa/solicitar_turno.py
import argparse
import os
import sys
...
from backend.services.calendar_logic import next_n_slots, create_meeting, WEEKDAYS_ES, list_calendars
